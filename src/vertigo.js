...
;(function () {
  ...
  var initVertigo = function ($) {

    var LAYER_DEPTH = 500;
    // This MUST be kept in sync with $CARD_TRANSITION_DURATION in the Sass
    // file.
    ...
    /**
     * @param {jQuery} $el
     * @param {Function} modificationFn The function that causes a style
     * change.
     */
  ...
  if (typeof define === 'function' && define.amd) {
    ...
    define(['jquery', 'jquery-mousewheel'], initVertigo);
  } else if (typeof exports === 'object') {
    // Node/CommonJS style for Browserify
    module.exports = initVertigo;
  } else {
    // Browser globals
    initVertigo(jQuery);
  }
